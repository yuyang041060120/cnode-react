        ...
        <div className="container">
          <div className="page-header">
            ...
            <p className="topic-message">
              ...
              <span>发表于{latestDate(topic.create_at)}</span>
              <i className="fa fa-user mg-l-5"></i>
              作者<Link to="user-detail" params={{loginname: topic.author.loginname}}>{topic.author.loginname}</Link>
            ...
            return (
              <div className="media">
                ...
                <div className="media-body">
                  <span className="pull-right"><i className="fa fa-thumbs-o-up"></i>{reply.ups.length}</span>
                  <h5 className="media-heading">
                    <a href={'/user/' + reply.author.loginname}>{reply.author.loginname}</a>
                    <span className="reply-date">发表于{latestDate(reply.create_at)}</span>
                  </h5>
